 ...
 */
function mantelzorger_header_info()
{
    ?>
    <?php
...
<div class="hgroup-wrap">
  <div class="container clearfix">
    ...
    <h1>
        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>" id="brand" rel="home">
            <img src="/wp-content/themes/zichtopmantelzorg/images/logo-footer.png" alt="Hogent"/>
